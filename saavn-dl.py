...
def download_album(album_choice):
    ...
    path= album_choice['album']+" - " +album_choice['singers']
...
def song_download(song_data):   
    ...
    filename = wget.download(song_data['url'], "Saavn_Downloader/"+song_data['title']+' - '+ song_data['singers']+'.mp3')
    meta_data(filename,song_data)
    clrscr()
...
choice = input("You want to download song or album (1 for song/2 for album): ")
